...
import com.example.self.edu.twitterclient.databinding.FragmentWordBinding;
...
public class WordFragment extends Fragment {
  ...
  private FragmentWordBinding mBinding;
  ...
  public void onActivityCreated(@Nullable Bundle savedInstanceState) {
    ...
    mBinding = FragmentWordBinding.bind(getView());
    ...
    TweetTimelineListAdapter timelineListAdapter = new TweetTimelineListAdapter
            ...
            .setOnActionCallback(new Callback<Tweet>() {
              ...
              public void failure(TwitterException exception) {
                mBinding.errorText.setText("単語での検索に失敗しちったごめんね");
                mBinding.progress.setVisibility(View.GONE);
              }
            })
            .build();
    mBinding.wordList.setAdapter(timelineListAdapter);
  }
}
